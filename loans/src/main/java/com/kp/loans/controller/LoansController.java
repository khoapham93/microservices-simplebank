package com.kp.loans.controller;

import com.kp.loans.constants.LoansConstants;
...
@Tag(
        ...
        description = "CRUD REST APIs in SimpleBank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
